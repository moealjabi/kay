          ...
          <Box key={sectionIndex}>
            ...
            <Grid.Root gap={4}>
              {section.items.map((input: any, i: number) => {
                ...
                // When extending the yup schema of an existing field (like in https://github.com/moealjabi/kay/blob/293ff3b8f9559236609d123a2774e3be05ce8274/packages/strapi-plugin-i18n/admin/src/index.js#L52)
