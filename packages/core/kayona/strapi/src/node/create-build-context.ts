...
const createBuildContext = async <TOptions extends BaseOptions>({
  ...
  const env = getStrapiAdminEnvVars({
    ...
    KAYONA_ADMIN_BACKEND_URL: sameOrigin ? serverPublicPath : serverAbsoluteUrl,
    KAYONA_TELEMETRY_DISABLED: String(strapiInstance.telemetry.isDisabled),
    ...
    KAYONA_ANALYTICS_URL: process.env.KAYONA_ANALYTICS_URL || 'https://analytics.kayona.io',
  });
