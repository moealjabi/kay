        ...
        <Box>
          <Tabs.Content value="cloud">
            <Flex direction="column" paddingTop={6}>
              <Box>
                <BaseLink
                  isExternal
                  href="https://cloud.kayona.io/login?utm_campaign=Strapi%20Cloud%20Plugin&utm_source=In-Product&utm_medium=CTA"
                >
              ...
              <Box paddingTop={5}>
                <Link isExternal href="https://docs.kayona.io/cloud/getting-started/deployment">
                  {documentationLink}
                </Link>
              </Box>
            </Flex>
          ...
          <Tabs.Content value="cli">
            <Flex direction="column" paddingTop={6}>
              ...
              <Box paddingTop={5}>
                <Link isExternal href="https://docs.kayona.io/cloud/getting-started/deployment-cli">
                  {documentationLink}
                </Link>
              </Box>
            </Flex>
