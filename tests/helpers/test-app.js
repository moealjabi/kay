...
const generateTestApp = async ({ appPath, database, template, link = false }) => {
  ...
  const scope = {
    ...
    dependencies: {
      '@kayona/strapi': pkg.version,
      '@kayona/plugin-users-permissions': pkg.version,
      '@kayona/plugin-graphql': pkg.version,
      '@kayona/plugin-documentation': pkg.version,
      '@kayona/plugin-cloud': pkg.version,
      react: '18.2.0',
      'react-dom': '18.2.0',
